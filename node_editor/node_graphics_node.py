...
class QDMGraphicsNode(QGraphicsItem):
    def __init__(self,node,parent = None):
        ...
        self._title_color = Qt.white            #标题颜色设置为白色
        self._title_font = QFont("Ubuntu",10)   #设置title字体


        self.width = 180                            #宽
        self.height = 240                           #高
        self.edge_size = 10.0                       #线条粗细
        self.title_height = 24.0                    #title高度
        self._padding = 4.0

        self._pen_default = QPen(QColor("#7F000000"))  #设置颜色
